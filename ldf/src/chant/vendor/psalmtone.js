/*
 * Vendored from https://github.com/bbloomf/jgabc/blob/master/psalmtone.js
 * License: The Unlicense (https://unlicense.org/) — public domain dedication
 * Vendored: 2026-04-22
 * SHA (upstream HEAD at vendoring time): 4e5a738475955f2e977e2d44a7b5cbba224c6828
 *
 * Adaptations:
 *   - None at vendoring time. See point-psalm.ts for the TS wrapper.
 *   - Future edits to this file should bump the vendoring date and SHA.
 */
